...
public class AppValidationAdapter : AttributeAdapterBase<ModelAwareValidationAttribute>
{
    public AppValidationAdapter(ModelAwareValidationAttribute attribute, IStringLocalizer stringLocalizer)
